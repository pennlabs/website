  ...
  <Section>
    <Container>
      ...
      <ol>
        ...
        <li>
          <b>Technical challenge</b> where you can show off your skills. You'll
          be given a few days to complete a take-home challenge. We hold an
          office hours event and are always available via email for questions.
        </li>
      </ol>
    </Container>
  </Section>
